...
function Title() {
  ...
  return (
    <div className="row justtify-content-center align-items-center ">
      ...
      <div
        className="col-9 d-flex align-items-center justify-content-end"
        id={s.buttons}
      >
        {user.email ? (
        ...
        <div className="col-auto">
          <Link to="/favorites" id={s.link} className="col-auto title-text">
            🧡 Fav
          </Link>
        </div>
        <div className="col-auto">
          <Link to="/cart" id={s.link} className="col-auto title-text">
            🛒 Cart
          </Link>
        </div>
      </div>
